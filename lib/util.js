...
exports.getCacheKey = function(prefix, params) {
  exports.sortJSON(params);
  return 'cache-' + exports.checksum(prefix + JSON.stringify(params));
};
